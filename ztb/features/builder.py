...
:class:`~ztb.features.baseline.PrincipalProfile` (their decayed history and sliding
...
from ztb.config import FEATURE_GROUPS, N_FEATURES
from ztb.features.baseline import PrincipalProfile
from ztb.features.schema import CloudEvent
...
def build_vector(
    ...
    # resource (5)
    own_bucket = f"ztb-{(org.get('functional_unit') or org.get('business_unit') or '')}"
    cross_account = 0.0
