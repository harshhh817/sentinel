...
queries and VerifyChain -- as an in-process :class:`~ztb.pdp.queue.LedgerSink`. It is
...
from ztb.pdp.chain import GENESIS, record_hash
from ztb.pdp.signer import Verifier
